...
session_start();
    ...
    $id=$_GET['id'];
        ...
        $majorSql = "SELECT * FROM major WHERE id = '$id'";
...
<form class="form" method="POST" action="../controllers/Umajor.php">
...
<div class="row ">
  ...
  <input name="id" type="hidden" value="<?php echo $id; ?>">
    ...
    <input name="majorName" type="text" class="form-control form-control-lg" id="colFormLabelLg" value="<?php echo $row['title']; ?>">
